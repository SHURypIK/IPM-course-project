...
public class AdminRepo {
    ...
    private final static String GetURL = "http://localhost:8080/admin/all";
    private final static String DeleteURL = "http://localhost:8080/admin/delete/";
    private final static String AddURL = "http://localhost:8080/admin/new";
            ...
            try (CloseableHttpResponse response = client.execute(httpPost)) {
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    if (jsonElement.isJsonObject()) {
                        Admin admin1 = gson.fromJson(jsonElement, Admin.class);
                        return admin1;
    ...
    public static ArrayList<Admin> get() throws Exception {
            ...
            try (CloseableHttpResponse response = client.execute(httpGet)) {
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    if (jsonElement.isJsonArray()) {
                        ArrayList<Admin> admins = gson.fromJson(jsonElement, adminListType);
                        return admins;
