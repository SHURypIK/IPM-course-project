...
public class RoomRepo {
    ...
    private final static String UpdateURL = "http://localhost:8080/room/update/";
    private final static String DeleteURL = "http://localhost:8080/room/delete/";
    private final static String AddURL = "http://localhost:8080/room/add";
            ...
            try (CloseableHttpResponse response = client.execute(httpPost)) {
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    if (jsonElement.isJsonObject()) {
                        Room room1 = gson.fromJson(jsonElement, Room.class);
                        return room1;
    ...
    public static Room update(Room room, int id) throws Exception {
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();
