...
public class FloorRepo {
    ...
    private final static String UpdateURL = "http://localhost:8080/floor/update/";
    private final static String DeleteURL = "http://localhost:8080/floor/delete/";
    private final static String AddURL = "http://localhost:8080/floor/add";

    public static Floor add(Floor floor) throws Exception {
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();

        String jsonBody = gson.toJson(floor);
            ...
            try (CloseableHttpResponse response = client.execute(httpPost)) {
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    if (jsonElement.isJsonObject()) {
                        Floor floor1 = gson.fromJson(jsonElement, Floor.class);
                        return floor1;
    ...
    public static Floor update(Floor floor, int id) throws Exception {
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();
