...
public class DormitoryRepo {
    ...
    private final static String UpdateURL = "http://localhost:8080/dormitory/update/";
    private final static String DeleteURL = "http://localhost:8080/dormitory/delete/";
    private final static String AddURL = "http://localhost:8080/dormitory/add";

    public static Dormitory add(Dormitory dormitory) throws Exception {
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();

        String jsonBody = gson.toJson(dormitory);
            ...
            try (CloseableHttpResponse response = client.execute(httpPost)) {
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    if (jsonElement.isJsonObject()) {
                        Dormitory dormitory1 = gson.fromJson(jsonElement, Dormitory.class);
                        return dormitory1;
    ...
    public static Dormitory update(Dormitory dormitory, int id) throws Exception {
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();
